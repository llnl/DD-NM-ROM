...
#flux: --error=train_rom_port_err.txt
#flux: --job-name=train_rom_port
#flux: --output=train_rom_port_out.txt
...
python -u ./../../steady/scripts/train_rom_port.py --inpfile ./../inputs/train_rom_port.json
